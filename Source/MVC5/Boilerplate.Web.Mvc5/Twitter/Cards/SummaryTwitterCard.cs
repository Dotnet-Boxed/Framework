namespace Boilerplate.Web.Mvc.Twitter
{
    ...
    /// <summary>
    /// The Summary Card can be used for many kinds of web content, from blog posts and news articles, to products and
    /// restaurants. It is designed to give the reader a preview of the content before clicking through to your website.
    ...
    public class SummaryTwitterCard : TwitterCard
    {
        ...
        /// as your website logo, author photo, or other image that spans multiple pages. The image must be a minimum
        /// size of 120px by 120px and must be less than 1MB in file size. For an expanded tweet and its detail page, the
        /// image will be cropped to a 4:3 aspect ratio and resized to be displayed at 120px by 90px. The image will also
        /// be cropped and resized to 120px by 120px for use in embedded tweets. If you are using Facebook's Open Graph
        /// og:image, you do not have to use this unless you want a different image but it is recommended to get supply a
        /// smaller image that fits Twitters needs.
        /// </summary>
