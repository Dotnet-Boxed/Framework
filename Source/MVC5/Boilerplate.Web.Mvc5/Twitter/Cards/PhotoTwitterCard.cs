namespace Boilerplate.Web.Mvc.Twitter
{
    ...
    public class PhotoTwitterCard : TwitterCard
    {
        ...
        /// <summary>
        /// Gets the image. A URL to the image representing the content. Image must be less than 1MB in size.
        ...
        /// </summary>
        public override TwitterCardType Type => TwitterCardType.Photo;
