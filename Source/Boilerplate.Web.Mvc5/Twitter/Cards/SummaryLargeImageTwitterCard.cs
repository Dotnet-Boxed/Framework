namespace Boilerplate.Web.Mvc.Twitter
{
    ...
    /// <summary>
    /// The Summary Card with Large Image features a large, full-width prominent image alongside a tweet. It is designed
    /// to give the reader a rich photo experience, and clicking on the image brings the user to your website. On
    /// twitter.com and the mobile clients, the image appears below the tweet text. See
    ...
    public class SummaryLargeImageTwitterCard : TwitterCard
    {
        ...
        /// </summary>
        /// <param name="username">
        /// The Twitter username of the creator of the content on the page e.g. @RehanSaeedUK. This is an optional
        /// property.
        /// </param>
        ...
        /// optional property.
        /// </summary>
        /// <value>The Twitter username of the creator of the content on the page e.g. @RehanSaeedUK.</value>
        ...
        /// <summary>
        /// Gets or sets the URL to a unique image representing the content of the page. Do not use a generic image such
        /// as your website logo, author photo, or other image that spans multiple pages. Images for this Card should be
        /// at least 280px in width, and at least 150px in height. Image must be less than 1MB in size. If you are using
        /// Facebook's Open Graph og:image, you do not have to use this unless you want a different image but it is
        /// recommended to get supply a smaller image that fits Twitters needs.
        /// </summary>
        /// <value>The URL to a unique image representing the content of the page. Do not use a generic images.</value>
        ...
        /// are using Facebook's Open Graph og:title, do not use this unless you want a different description.
        /// </summary>
