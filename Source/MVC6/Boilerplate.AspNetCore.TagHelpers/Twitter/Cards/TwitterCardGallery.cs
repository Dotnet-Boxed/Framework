namespace Boilerplate.AspNetCore.TagHelpers.Twitter
{
    ...
    [HtmlTargetElement(
        ...
        Attributes = UsernameAttributeName + "," + Image0AttributeName + "," + Image1AttributeName + "," + Image2AttributeName + "," + Image3AttributeName,
    ...
    public class TwitterCardGallery : TwitterCard
    {
        ...
        protected override void Validate()
        {
            ...
            if (this.Image0 == null)
            {
                throw new ArgumentNullException(nameof(this.Image0));
            }

            if (this.Image1 == null)
            {
                throw new ArgumentNullException(nameof(this.Image1));
            }

            if (this.Image2 == null)
            {
                throw new ArgumentNullException(nameof(this.Image2));
            }

            if (this.Image3 == null)
            {
                throw new ArgumentNullException(nameof(this.Image3));
            }
        }
    }
}
