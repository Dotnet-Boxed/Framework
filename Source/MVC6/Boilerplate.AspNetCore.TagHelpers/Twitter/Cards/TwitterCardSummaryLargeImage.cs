namespace Boilerplate.AspNetCore.TagHelpers.Twitter
{
    ...
    public class TwitterCardSummaryLargeImage : TwitterCard
    {
        ...
        /// </summary>
        /// <value>
        /// The Twitter username of the creator of the content on the page e.g. @RehanSaeedUK.
        /// </value>
        ...
        /// </summary>
        /// <value>
        /// The description that concisely summarizes the content of the page, as appropriate for presentation within a Tweet. Description text will be truncated at the word to 200 characters.
        /// </value>
        [HtmlAttributeName(DescriptionAttributeName)]
        public string Description { get; set; }

        /// <summary>
        /// Gets or sets the URL to a unique image representing the content of the page. Do not use a generic image such as your website logo, author photo, or other image that spans multiple pages. Images for this Card should be at least 280px in width, and at least 150px in height. Image must be less than 1MB in size. If you are using Facebook's Open Graph og:image, you do not have to use this unless you want a different image but it is recommended to get supply a smaller image that fits
        /// Twitters needs.
        /// </summary>
        /// <value>
        /// A concise title for the related content. Platform specific behaviors: iOS, Android: Truncated to two lines in timeline and expanded Tweet.
        ...
        /// <summary>
        /// Gets or sets the title of the summary. Title should be concise and will be truncated at 70 characters. If you are using Facebook's Open Graph og:title, do not use this unless you want a different description.
        /// </summary>
        /// <value>
        /// The A concise title for the related content. Title should be concise and will be truncated at 70 characters.
        /// </value>
