namespace Boilerplate.AspNetCore.TagHelpers.Twitter
{
    ...
    /// <summary>
    /// The App Card is a great way to represent mobile applications on Twitter and to drive installs. The app card is
    /// designed to allow for a name, description and icon, and also to highlight attributes such as the rating and the
    /// price. This Card type is currently available on the twitter.com website, as well as iOS and Android mobile
    ...
    public class TwitterCardApp : TwitterCard
    {
        ...
        /// <summary>
        /// Gets or sets the country. If your application is not available in the US App Store, you must set this value
        /// to the two-letter country code for the App Store that contains your application.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the app ID in the Google Play Store (.i.e. “com.android.app”).
        /// </summary>
        /// <value>The app ID in the Google Play Store (.i.e. “com.android.app”).</value>
        ...
        /// </summary>
        /// <value>The google play app’s custom URL scheme which will include “://” after the scheme name.</value>
        ...
        /// </summary>
        /// <value>The numeric representation of your iPad app ID in the App Store (.i.e. “307234931”).</value>
        ...
        /// </summary>
        /// <value>The iPad app’s custom URL scheme which will include “://” after the scheme name.</value>
        ...
        /// </summary>
        /// <value>The numeric representation of your iPhone app ID in the App Store (.i.e. “307234931”).</value>
        ...
        /// </summary>
        /// <value>The iPhone app’s custom URL scheme which will include “://” after the scheme name.</value>
